...
def landmarks(t: Terrain):
    ...
    place(t, "vincent", cx - 2.2, cy + 0.6, characters.vincent, rot_z=-0.5, id="vincent")
    place(t, "guitar_case", cx - 3.2, cy - 0.9, props.guitar_case, rot_z=0.4, id="guitar_case")
    place(t, "log", cx + 2.0, cy - 0.4, props.log_seat, rot_z=1.9)
    place(t, "log", cx + 0.2, cy + 2.2, props.log_seat, rot_z=0.2)
